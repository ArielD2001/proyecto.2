...
$parametro = 'PROFESOR';
$usuarios = 'SELECT * FROM usuarios WHERE rol = ?';
$su = $mbd->prepare($usuarios);
$su->bindParam(1, $parametro);
$su->execute();
                    ...
                    <div class="row">
                        ...
                        <div class="col-12" id="app">
                            <div class="card ">
                                ...
                                <div class="card-body " id="card-body" style="max-width: 1200px">
                                    <?php
                                    if (isset($_GET['lista'])) {
                                                                        ...
                                                                        <div class="row border p-3 rounded">
                                                                            <form method="post" accept=".xls,.xlsx" id="formulario-list" enctype="multipart/form-data" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate" accept=".xlsx">
                                                                                <div class="row ">
                                                                                    ...
                                                                                    <div class="col-6 mt-2">
                                                                                    <label class="form-label" for="id_usuario">Profesor</label>

                                                                                        <select name="id_usuario" id="id_usuairo" class="form-select">
                                                                                            <option value="">seleccionar</option>
                                                                                            <?php foreach($usuario as $user) {?>
                                                                                            <option value="<?php echo $user['id'] ?>"><?php echo ucwords($user['nombre'])." ".ucwords($user['apellido']) ; ?></option>
                                                                                            <?php }?>
                                                                                        </select>
                                                                                    </div>
                                                                                    <div class="col-6 pt-1">
                                                                                        <button type="button" name="agregar-list" class="w-100 col-6 btn btn-success mt-4" id="agregar-list">Subir
                                                                                            Lista</button>
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <table class="table table-sm table-centered mb-5 py-3  w-100 "  id="tablas">
                                                    <thead class="text-center bg-dark text-white">
                                                        <tr>
                                                            ...
                                                            <th>Semestre</th>
                                                            <th class="d-md-table-cell d-none"> Estudiantes</th>
                                                            <th class="d-sm-table-cell d-none">Fecha de añadido</th>
                                                            <?php
                                                            if (isset($_SESSION['admin']))
                                                                echo '<th>Opciones</th>'
                                                            ?>
