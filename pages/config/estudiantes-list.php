                            ...
                            <tr>
                                ...
                                <?php if ($modulo['rotaciones'] > 1){ ?>
                                   ...
                                   //Calificacion de la rotacion 1
                                    $notar1 = "SELECT *  FROM respuestas WHERE id_estudiante = ? AND rotacion = ?  AND id_lista = ?";
                                    $r1 = $mbd->prepare($notar1);
                                   
                                    $r1->execute(array($dato['id'], 1, $ide));
                                    $nota = $r1->rowCount();
                                    $resr1 = $r1->fetch();
                                   ...
                                   //Calificacion de la rotacion 2
                                    $notar2 = "SELECT *  FROM respuestas WHERE id_estudiante = ? AND rotacion = ? AND id_lista = ?";
                                    $r2 = $mbd->prepare($notar2);
                                   
                                    $r2->execute(array($dato['id'], 2, $ide));
                                    $nota = $r2->rowCount();
                                    $resr2 = $r2->fetch();
                                   ...
                                   //Calificacion de la rotacion 3
                                    $notar3 = "SELECT *  FROM respuestas WHERE id_estudiante = ? AND rotacion = ? AND id_lista = ?";
                                    $r3 = $mbd->prepare($notar3);
                                   
                                    $r3->execute(array($dato['id'], 3, $ide));
                                    $nota = $r3->rowCount();
                                    $resr3 = $r3->fetch();
